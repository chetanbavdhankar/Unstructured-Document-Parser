<model id="Model 83" code="TM-GEO-083">

<structured_metrics>
  <domain name="performance">
    | Metric | Value | Source |
    |--------|-------|--------|
    | True Positives | 402 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | False Positives | 397 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | False Negatives | 75 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | True Negatives | 82067 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | Total Alerts | 799 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | Total Population | 82941 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | Precision | 0.503128911138924 | Model_Performance_Metrics.xlsx/Precision_Recall_F1 |
    | Recall | 0.842767295597484 | Model_Performance_Metrics.xlsx/Precision_Recall_F1 |
    | F1 Score | 0.630094043887147 | Model_Performance_Metrics.xlsx/Precision_Recall_F1 |
    | Specificity | 0.995185778036477 | Model_Performance_Metrics.xlsx/Precision_Recall_F1 |
    | Total Alerts | 799 | Model_Performance_Metrics.xlsx/Alert_Volumes |
    | SARs Filed | 306 | Model_Performance_Metrics.xlsx/Alert_Volumes |
    | Conversion Rate | 0.382978723404255 | Model_Performance_Metrics.xlsx/Alert_Volumes |
    | Alerts / 1k Population | 9.63335382983084 | Model_Performance_Metrics.xlsx/Alert_Volumes |
    ...
    | F1 Score | 0.630094043887147 | Model_Performance_Metrics.xlsx/Effectiveness_Summary |
    | Conversion Rate | 0.382978723404255 | Model_Performance_Metrics.xlsx/Effectiveness_Summary |
    | Composite Effectiveness | 0.531247915693991 | Model_Performance_Metrics.xlsx/Effectiveness_Summary |
  ...
  <domain name="backtesting">
    ...
    | Effective Rate | 0.825 | Backtesting_Results.xlsx/ATL_Testing |
    ...
    | Confirmed Clean | 76 | Backtesting_Results.xlsx/BTL_Testing |
    | Leakage Rate | 0.0256410256410256 | Backtesting_Results.xlsx/BTL_Testing |
    | BTL Outcome | Pass | Backtesting_Results.xlsx/BTL_Testing |
    | Quarter | Q1 2025 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Alerts | 877 | Backtesting_Results.xlsx/Quarterly_Trend |
    | SARs | 43 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Conversion Rate | 0.0490307867730901 | Backtesting_Results.xlsx/Quarterly_Trend |
    | QoQ Alert Delta | n/a | Backtesting_Results.xlsx/Quarterly_Trend |
    | Quarter | Q2 2025 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Alerts | 691 | Backtesting_Results.xlsx/Quarterly_Trend |
    | SARs | 72 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Conversion Rate | 0.104196816208394 | Backtesting_Results.xlsx/Quarterly_Trend |
    | QoQ Alert Delta | -186 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Quarter | Q3 2025 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Alerts | 892 | Backtesting_Results.xlsx/Quarterly_Trend |
    | SARs | 48 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Conversion Rate | 0.0538116591928251 | Backtesting_Results.xlsx/Quarterly_Trend |
    | QoQ Alert Delta | 201 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Quarter | Q4 2025 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Alerts | 680 | Backtesting_Results.xlsx/Quarterly_Trend |
    | SARs | 61 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Conversion Rate | 0.0897058823529412 | Backtesting_Results.xlsx/Quarterly_Trend |
    | QoQ Alert Delta | -212 | Backtesting_Results.xlsx/Quarterly_Trend |
    ...
    | Q1 2025/Alerts | 877 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q1 2025/SARs | 43 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q1 2025/Conversion Rate | 0.0490307867730901 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q1 2025/QoQ Alert Delta | n/a | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q2 2025/Alerts | 691 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q2 2025/SARs | 72 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q2 2025/Conversion Rate | 0.104196816208394 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q2 2025/QoQ Alert Delta | -186 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q3 2025/Alerts | 892 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q3 2025/SARs | 48 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q3 2025/Conversion Rate | 0.0538116591928251 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q3 2025/QoQ Alert Delta | 201 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q4 2025/Alerts | 680 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q4 2025/SARs | 61 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q4 2025/Conversion Rate | 0.0897058823529412 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q4 2025/QoQ Alert Delta | -212 | Backtesting_Results.xlsx/Quarterly_Trend |
  ...
  <domain name="data_quality">
    | Metric | Value | Source |
    |--------|-------|--------|
    | Expected Records | 474405 | Data_Quality.xlsx/Completeness |
    | Populated Records | 428787 | Data_Quality.xlsx/Completeness |
    | Completeness | 0.903841654282733 | Data_Quality.xlsx/Completeness |
    | DQ Flag | Red | Data_Quality.xlsx/Completeness |
    | Records Checked | 183924 | Data_Quality.xlsx/Accuracy |
    | Failed Validation | 2089 | Data_Quality.xlsx/Accuracy |
    | Accuracy | 0.988642047802353 | Data_Quality.xlsx/Accuracy |
    | DQ Flag | Amber | Data_Quality.xlsx/Accuracy |
    | Feeds Expected | 58 | Data_Quality.xlsx/Timeliness |
    | Feeds On-Time | 56 | Data_Quality.xlsx/Timeliness |
    | On-Time Rate | 0.96551724137931 | Data_Quality.xlsx/Timeliness |
    | Avg Delay (hrs) | 5.7 | Data_Quality.xlsx/Timeliness |
  ...
  <domain name="governance">
    ...
    | Residual Risk Score | 36.5 | Model_Risk_Governance.xlsx/Risk_Tiering |
    ...
    | Deploy Date | 2023-02-23 | Model_Risk_Governance.xlsx/Lifecycle_Status |
    | Lifecycle Status | Validation | Model_Risk_Governance.xlsx/Lifecycle_Status |
    | Next Review Due | 2025-02-23 | Model_Risk_Governance.xlsx/Lifecycle_Status |
  ...
  <domain name="dq_issues">
    | Metric | Value | Source |
    |--------|-------|--------|
    | DQ_Issue_Log | issue_id: DQ-026 | source_system: KYC-Master | issue_description: Truncated narrative field | status: Open | linked_cr: None | DQ_Issue_Log |
...
### 3.83 Model 83 — High-Risk Jurisdiction

| **Model Code**                 | TM-GEO-083                                                                          |
|--------------------------------|-------------------------------------------------------------------------------------|

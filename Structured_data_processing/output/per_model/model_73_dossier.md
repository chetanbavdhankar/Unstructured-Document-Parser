<model id="Model 73" code="TM-STR-073">

<structured_metrics>
  <domain name="performance">
    | Metric | Value | Source |
    |--------|-------|--------|
    | True Positives | 136 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | False Positives | 517 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | False Negatives | 79 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | True Negatives | 59083 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | Total Alerts | 653 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | Total Population | 59815 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | Precision | 0.208269525267994 | Model_Performance_Metrics.xlsx/Precision_Recall_F1 |
    | Recall | 0.632558139534884 | Model_Performance_Metrics.xlsx/Precision_Recall_F1 |
    | F1 Score | 0.313364055299539 | Model_Performance_Metrics.xlsx/Precision_Recall_F1 |
    | Specificity | 0.991325503355705 | Model_Performance_Metrics.xlsx/Precision_Recall_F1 |
    | Total Alerts | 653 | Model_Performance_Metrics.xlsx/Alert_Volumes |
    | SARs Filed | 53 | Model_Performance_Metrics.xlsx/Alert_Volumes |
    | Conversion Rate | 0.0811638591117917 | Model_Performance_Metrics.xlsx/Alert_Volumes |
    | Alerts / 1k Population | 10.9169940650339 | Model_Performance_Metrics.xlsx/Alert_Volumes |
    ...
    | F1 Score | 0.313364055299539 | Model_Performance_Metrics.xlsx/Effectiveness_Summary |
    | Conversion Rate | 0.0811638591117917 | Model_Performance_Metrics.xlsx/Effectiveness_Summary |
    | Composite Effectiveness | 0.22048397682444 | Model_Performance_Metrics.xlsx/Effectiveness_Summary |
  ...
  <domain name="backtesting">
    ...
    | Effective Rate | 0.727272727272727 | Backtesting_Results.xlsx/ATL_Testing |
    | ATL Outcome | Pass | Backtesting_Results.xlsx/ATL_Testing |
    | Below-Line Sampled | 88 | Backtesting_Results.xlsx/BTL_Testing |
    | Missed Alerts (Should-Fire) | 8 | Backtesting_Results.xlsx/BTL_Testing |
    | Confirmed Clean | 80 | Backtesting_Results.xlsx/BTL_Testing |
    | Leakage Rate | 0.0909090909090909 | Backtesting_Results.xlsx/BTL_Testing |
    | BTL Outcome | Threshold Review | Backtesting_Results.xlsx/BTL_Testing |
    | Quarter | Q1 2025 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Alerts | 707 | Backtesting_Results.xlsx/Quarterly_Trend |
    | SARs | 72 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Conversion Rate | 0.101838755304102 | Backtesting_Results.xlsx/Quarterly_Trend |
    | QoQ Alert Delta | n/a | Backtesting_Results.xlsx/Quarterly_Trend |
    | Quarter | Q2 2025 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Alerts | 697 | Backtesting_Results.xlsx/Quarterly_Trend |
    | SARs | 64 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Conversion Rate | 0.0918220946915352 | Backtesting_Results.xlsx/Quarterly_Trend |
    | QoQ Alert Delta | -10 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Quarter | Q3 2025 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Alerts | 562 | Backtesting_Results.xlsx/Quarterly_Trend |
    | SARs | 36 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Conversion Rate | 0.0640569395017794 | Backtesting_Results.xlsx/Quarterly_Trend |
    | QoQ Alert Delta | -135 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Quarter | Q4 2025 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Alerts | 614 | Backtesting_Results.xlsx/Quarterly_Trend |
    | SARs | 31 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Conversion Rate | 0.0504885993485342 | Backtesting_Results.xlsx/Quarterly_Trend |
    ...
    | Q1 2025/Alerts | 707 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q1 2025/SARs | 72 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q1 2025/Conversion Rate | 0.101838755304102 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q1 2025/QoQ Alert Delta | n/a | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q2 2025/Alerts | 697 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q2 2025/SARs | 64 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q2 2025/Conversion Rate | 0.0918220946915352 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q2 2025/QoQ Alert Delta | -10 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q3 2025/Alerts | 562 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q3 2025/SARs | 36 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q3 2025/Conversion Rate | 0.0640569395017794 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q3 2025/QoQ Alert Delta | -135 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q4 2025/Alerts | 614 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q4 2025/SARs | 31 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q4 2025/Conversion Rate | 0.0504885993485342 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q4 2025/QoQ Alert Delta | 52 | Backtesting_Results.xlsx/Quarterly_Trend |
  ...
  <domain name="data_quality">
    | Metric | Value | Source |
    |--------|-------|--------|
    | Expected Records | 411329 | Data_Quality.xlsx/Completeness |
    | Populated Records | 375656 | Data_Quality.xlsx/Completeness |
    | Completeness | 0.913273802722395 | Data_Quality.xlsx/Completeness |
    | DQ Flag | Red | Data_Quality.xlsx/Completeness |
    | Records Checked | 73452 | Data_Quality.xlsx/Accuracy |
    | Failed Validation | 2442 | Data_Quality.xlsx/Accuracy |
    | Accuracy | 0.966753798398954 | Data_Quality.xlsx/Accuracy |
    ...
    | On-Time Rate | 0.882352941176471 | Data_Quality.xlsx/Timeliness |
  ...
  <domain name="governance">
    ...
    | Residual Risk Score | 5.46 | Model_Risk_Governance.xlsx/Risk_Tiering |
...
### 3.73 Model 73 — Sanctions Proximity

| **Model Code**                 | TM-STR-073                                                                          |
|--------------------------------|-------------------------------------------------------------------------------------|

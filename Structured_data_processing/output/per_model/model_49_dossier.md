<model id="Model 49" code="TM-STR-049">
...
<structured_metrics>
  <domain name="performance">
    ...
    | False Positives | 237 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | False Negatives | 75 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | True Negatives | 27188 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | Total Alerts | 789 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | Total Population | 28052 | Model_Performance_Metrics.xlsx/Confusion_Matrix |
    | Precision | 0.699619771863118 | Model_Performance_Metrics.xlsx/Precision_Recall_F1 |
    | Recall | 0.880382775119617 | Model_Performance_Metrics.xlsx/Precision_Recall_F1 |
    | F1 Score | 0.779661016949153 | Model_Performance_Metrics.xlsx/Precision_Recall_F1 |
    | Specificity | 0.991358249772106 | Model_Performance_Metrics.xlsx/Precision_Recall_F1 |
    | Total Alerts | 789 | Model_Performance_Metrics.xlsx/Alert_Volumes |
    | SARs Filed | 276 | Model_Performance_Metrics.xlsx/Alert_Volumes |
    | Conversion Rate | 0.349809885931559 | Model_Performance_Metrics.xlsx/Alert_Volumes |
    | Alerts / 1k Population | 28.12633680308 | Model_Performance_Metrics.xlsx/Alert_Volumes |
    ...
    | F1 Score | 0.779661016949153 | Model_Performance_Metrics.xlsx/Effectiveness_Summary |
    | Conversion Rate | 0.349809885931559 | Model_Performance_Metrics.xlsx/Effectiveness_Summary |
    | Composite Effectiveness | 0.607720564542115 | Model_Performance_Metrics.xlsx/Effectiveness_Summary |
  ...
  <domain name="backtesting">
    ...
    | Confirmed Productive | 65 | Backtesting_Results.xlsx/ATL_Testing |
    | False Positive | 53 | Backtesting_Results.xlsx/ATL_Testing |
    | Effective Rate | 0.550847457627119 | Backtesting_Results.xlsx/ATL_Testing |
    | ATL Outcome | Pass | Backtesting_Results.xlsx/ATL_Testing |
    | Below-Line Sampled | 135 | Backtesting_Results.xlsx/BTL_Testing |
    ...
    | Alerts | 714 | Backtesting_Results.xlsx/Quarterly_Trend |
    | SARs | 57 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Conversion Rate | 0.0798319327731092 | Backtesting_Results.xlsx/Quarterly_Trend |
    | QoQ Alert Delta | n/a | Backtesting_Results.xlsx/Quarterly_Trend |
    | Quarter | Q2 2025 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Alerts | 782 | Backtesting_Results.xlsx/Quarterly_Trend |
    | SARs | 36 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Conversion Rate | 0.0460358056265985 | Backtesting_Results.xlsx/Quarterly_Trend |
    | QoQ Alert Delta | 68 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Quarter | Q3 2025 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Alerts | 854 | Backtesting_Results.xlsx/Quarterly_Trend |
    | SARs | 83 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Conversion Rate | 0.0971896955503513 | Backtesting_Results.xlsx/Quarterly_Trend |
    | QoQ Alert Delta | 72 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Quarter | Q4 2025 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Alerts | 713 | Backtesting_Results.xlsx/Quarterly_Trend |
    | SARs | 63 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Conversion Rate | 0.08835904628331 | Backtesting_Results.xlsx/Quarterly_Trend |
    | QoQ Alert Delta | -141 | Backtesting_Results.xlsx/Quarterly_Trend |
    ...
    | Q1 2025/Alerts | 714 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q1 2025/SARs | 57 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q1 2025/Conversion Rate | 0.0798319327731092 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q1 2025/QoQ Alert Delta | n/a | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q2 2025/Alerts | 782 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q2 2025/SARs | 36 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q2 2025/Conversion Rate | 0.0460358056265985 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q2 2025/QoQ Alert Delta | 68 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q3 2025/Alerts | 854 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q3 2025/SARs | 83 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q3 2025/Conversion Rate | 0.0971896955503513 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q3 2025/QoQ Alert Delta | 72 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q4 2025/Alerts | 713 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q4 2025/SARs | 63 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q4 2025/Conversion Rate | 0.08835904628331 | Backtesting_Results.xlsx/Quarterly_Trend |
    | Q4 2025/QoQ Alert Delta | -141 | Backtesting_Results.xlsx/Quarterly_Trend |
  ...
  <domain name="data_quality">
    | Metric | Value | Source |
    |--------|-------|--------|
    | Expected Records | 363481 | Data_Quality.xlsx/Completeness |
    | Populated Records | 358780 | Data_Quality.xlsx/Completeness |
    | Completeness | 0.987066724257939 | Data_Quality.xlsx/Completeness |
    | DQ Flag | Green | Data_Quality.xlsx/Completeness |
    | Records Checked | 117791 | Data_Quality.xlsx/Accuracy |
    | Failed Validation | 1524 | Data_Quality.xlsx/Accuracy |
    | Accuracy | 0.987061829851177 | Data_Quality.xlsx/Accuracy |
    | DQ Flag | Amber | Data_Quality.xlsx/Accuracy |
    | Feeds Expected | 110 | Data_Quality.xlsx/Timeliness |
    | Feeds On-Time | 108 | Data_Quality.xlsx/Timeliness |
  ...
  <domain name="governance">
    ...
    | Residual Risk Score | 38 | Model_Risk_Governance.xlsx/Risk_Tiering |
    ...
    | Deploy Date | 2024-02-17 | Model_Risk_Governance.xlsx/Lifecycle_Status |
    | Lifecycle Status | Production | Model_Risk_Governance.xlsx/Lifecycle_Status |
    | Next Review Due | 2026-02-17 | Model_Risk_Governance.xlsx/Lifecycle_Status |
...
### 3.49 Model 49 — Threshold Avoidance

| **Model Code**                 | TM-STR-049                                                                                   |
|--------------------------------|----------------------------------------------------------------------------------------------|
